...
('Manoj Kumar', 'Plumber', 'Kochi', '9876543210', 'manoj.kumar@example.com', 4.5, ARRAY['Pipe fitting', 'Drain cleaning', 'Leak repair'], 'Mon-Sat, 9am-6pm', 'https://api.dicebear.com/7.x/initials/svg?seed=MK&backgroundColor=00aaff&fontFamily=Arial', 'A reliable plumber with over 10 years of experience.', 10),
('Priya Nair', 'Electrician', 'Trivandrum', '9876543211', 'priya.nair@example.com', 4.8, ARRAY['Wiring', 'Fixture installation', 'Panel upgrades'], 'Mon-Fri, 10am-7pm', 'https://api.dicebear.com/7.x/initials/svg?seed=PN&backgroundColor=ff4d4d&fontFamily=Arial', 'Certified electrician specializing in residential and commercial projects.', 8),
('Anil Varma', 'Carpenter', 'Kozhikode', '9876543212', 'anil.varma@example.com', 4.2, ARRAY['Furniture making', 'Cabinetry', 'Door installation'], 'Mon-Sat, 8am-5pm', 'https://api.dicebear.com/7.x/initials/svg?seed=AV&backgroundColor=00aaff&fontFamily=Arial', 'Skilled carpenter with a passion for creating custom furniture.', 15),
('Sunitha Menon', 'House Painter', 'Thrissur', '9876543213', 'sunitha.menon@example.com', 4.9, ARRAY['Interior painting', 'Exterior painting', 'Texture painting'], 'Mon-Sun, 9am-6pm', 'https://api.dicebear.com/7.x/initials/svg?seed=SM&backgroundColor=ff4d4d&fontFamily=Arial', 'Experienced house painter known for high-quality work and attention to detail.', 12),
('Rajesh Pillai', 'AC Mechanic', 'Kollam', '9876543214', 'rajesh.pillai@example.com', 4.6, ARRAY['AC installation', 'AC repair', 'AC maintenance'], 'Mon-Sat, 9am-7pm', 'https://api.dicebear.com/7.x/initials/svg?seed=RP&backgroundColor=00aaff&fontFamily=Arial', 'Expert AC mechanic providing fast and efficient services.', 7);
